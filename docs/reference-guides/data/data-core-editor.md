...
Returns the slug for the post being edited, preferring a manually edited value if one exists, then the server-generated slug (locale-aware), then a sanitized version of the current post title, and finally the post ID.
